...
const images = [{ uri: 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimage.suning.cn%2Fuimg%2Fsop%2Fcommodity%2F116653756720291044813259_x.jpg&refer=http%3A%2F%2Fimage.suning.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1630212204&t=22ad86c170d88f61d711ee42232071d9' },
...
class exswiper extends Component {
    constructor(props) {
        ...
        this.state = {
            currentPage: 0,
            imgUrl: { uri: 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimage.suning.cn%2Fuimg%2Fsop%2Fcommodity%2F116653756720291044813259_x.jpg&refer=http%3A%2F%2Fimage.suning.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1630212204&t=22ad86c170d88f61d711ee42232071d9' }
        };
    }
                ...
                <View style={{ width: '100%', alignItems: 'center' }} >
                    <View>
                        <View style={styles.container}>
                            <EZSwiper style={[styles.swiper, { width: pxToDp(410), }]}
                                dataSource={images}
                                width={pxToDp(410)}
                                height={pxToDp(400)}
