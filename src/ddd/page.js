...
export default class page extends PureComponent{
    render(){
        ...
        return(
<ScrollView >
    <View style={{ backgroundColor:'green',width:'95%',height:'100%',margin:10,borderRadius:10}} >
...
<View style={{flex:1}}>
   {
           this.props.pagedata.img.map((item,id)=>(
               <View key={id} style={{flex:1}}>
                <Image key={id} source={{uri:item}} style={{width:'90%',height:300,alignSelf:'center',marginBottom:10,borderRadius:10}}/>
