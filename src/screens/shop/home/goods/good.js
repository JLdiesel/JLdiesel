    ...
    return (
      ...
      <View style={{backgroundColor:'transparent',position:'relative'}}>
        ...
        <ScrollView style={{ marginBottom:pxToDp(49) }}>
          ...
          <View style={{ marginLeft: pxToDp(10), marginTop: pxToDp(30), borderBottomWidth: 0.8, width: pxToDp(350), borderBottomColor: 'gray' }}>
          ...
          <View>
            <View style={{ marginLeft: pxToDp(10), marginTop: pxToDp(30), width: pxToDp(350), flexDirection: 'row', marginBottom: pxToDp(25) }}>
              <Text style={{ fontSize: pxToDp(10) , fontWeight: 'bold' }}>设计细节</Text>
            ...
            <View style={{ marginLeft: pxToDp(10) , marginTop:pxToDp(20) , borderBottomWidth: 0.8, width: pxToDp(350), borderBottomColor: 'gray' }}>
            ...
            <View style={{ marginLeft: pxToDp(10) , borderBottomWidth:.8, width: pxToDp(350), borderBottomColor: 'gray' }}>
              <Text style={{ fontSize: pxToDp(10) , fontWeight: 'bold', marginBottom: pxToDp(20) , marginTop: pxToDp(20) }}>商品规格</Text>
            </View>
            <View style={{ marginLeft:pxToDp(20), marginTop: 0, width: pxToDp(350) }}>
              <View style={{ flexDirection: 'row' }}>
                
                <Text style={{ fontSize: 20, fontWeight: 'bold', marginBottom: pxToDp(20), marginTop: pxToDp(20) }}>用户评价</Text>
              ...
              <View style={{  height: this.state.Commentheight,overflow:'hidden' }}>
        ...
        <View style={{ width: ScreenWidth, height: pxToDp(50), backgroundColor: '#fff', position: 'absolute', top: ScreenHeight - pxToDp(10), borderTopWidth: 0.8, borderTopColor: 'gray', justifyContent: 'center' }}>
          <View style={{ flexDirection: 'row' }}>
