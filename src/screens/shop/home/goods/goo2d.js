   ...
   outputRange: [16, 22, 16]
    ...
    return (
      <View style={{ backgroundColor: 'transparent', position: 'relative' }}>
        ...
        >
          <SvgUri
            svgXmlData={expandIcon}
            width="20"
            height="20"
            style={{ marginLeft: pxToDp(350) }}
          />
        </View>
        ...
        <ScrollView style={{ marginBottom: pxToDp(49) }}>
          ...
          <View>
            ...
            >
              ...
              <TouchableOpacity
                onPress={this.ChangeBoxheight}
                style={{ transform: [{ rotateX: this.state.angle }] }}
              >
                <SvgUri
                  svgXmlData={expandIcon}
                  width="20"
            ...
            >
              {this.state.items2.map((item, index) => {
                return (
                  <Image
                    resizeMode="cover"
                    style={{ width: 355, height: this.state.imagHeight }}
                    key={index}
                    source={{ uri: item }}
                  />
                );
