    ...
    render() {
        return (
            <ScrollView style={{ backgroundColor: '#E2F4FE', flex: 1 }}>
                ...
                <View style={styles.view}>
                    <View style={{ flexDirection: "row", justifyContent: "space-between", }}>
                        ...
                        <TouchableOpacity onPress={() => this.context.navigate('Optuijian')}>
                ...
                <TouchableOpacity onPress={() => this.context.navigate()}>
                    <View style={styles.box}>
                        <Image style={styles.image} source={require('../../../res/12.jpg')} />
                        <View style={styles.botbox}>
            ...
            <View style={styles.view}>
                ...
                <TouchableOpacity onPress={() => this.context.navigate()}>
                    <View style={styles.box}>
                        <Image style={styles.image} source={require('../../../res/play/6.jpg')} />
                        <View style={styles.botbox}>
                ...
                <TouchableOpacity onPress={() => this.context.navigate()}>
                    <View style={styles.box}>
                        <Image style={styles.image} source={require('../../../res/play/7.jpg')} />
                        <View style={styles.botbox}>
                ...
                <TouchableOpacity onPress={() => this.context.navigate()}>
                    <View style={styles.box}>
                        <Image style={styles.image} source={require('../../../res/play/8.jpg')} />
                        <View style={styles.botbox}>
            ...
            <View style={styles.view}>
                ...
                <TouchableOpacity onPress={() => this.context.navigate()}>
                    <View style={styles.box}>
                        <Image style={styles.image} source={require('../../../res/genre/2.jpg')} />
                        <View style={styles.botbox}>
                ...
                <TouchableOpacity onPress={() => this.context.navigate()}>
                    <View style={styles.box}>
                        <Image style={styles.image} source={require('../../../res/genre/4.jpg')} />
                        <View style={styles.botbox}>
                ...
                <TouchableOpacity onPress={() => this.context.navigate()}>
                    <View style={styles.box}>
                        <Image style={styles.image} source={require('../../../res/genre/7.jpg')} />
                        <View style={styles.botbox}>
                ...
                <TouchableOpacity onPress={() => this.context.navigate()}>
                    <View style={styles.box}>
                        <Image style={styles.image} source={require('../../../res/genre/8.jpg')} />
                        <View style={styles.botbox}>
