...
class hello extends Component {
  ...
  state={
    ...
    collect:[{collectid:1,
      ...
      ,title:'乌拉乌拉乌拉乌拉乌拉乌拉',playnum:111,label:'视频'},{collectid:2,
        collectimg:'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimg.pconline.com.cn%2Fimages%2Fupload%2Fupc%2Ftx%2Fitbbs%2F1501%2F10%2Fc5%2F1703828_1420863335187_mthumb.jpg&refer=http%3A%2F%2Fimg.pconline.com.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1631240166&t=6f9aea8e73cc81bb70adf7fe6241bded'
        ,title:'乌拉乌拉乌拉乌拉乌拉乌拉',playnum:111,label:'视频'},{collectid:3,
          collectimg:'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimg.pconline.com.cn%2Fimages%2Fupload%2Fupc%2Ftx%2Fitbbs%2F1501%2F10%2Fc5%2F1703828_1420863335187_mthumb.jpg&refer=http%3A%2F%2Fimg.pconline.com.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1631240166&t=6f9aea8e73cc81bb70adf7fe6241bded'
    ...
    navigationView = () => {
        return (
            <View style={{ flex: 1, backgroundColor: '#92d5dd' }}>
                <View style={{ alignSelf: 'center', marginTop: pxToDp(40)}}>
                    <TouchableOpacity onPress={this.close}>
                        <Text style={styles.textStyle}>点击关闭侧边栏</Text>
                    </TouchableOpacity>
                </View>
                <View style={{ alignSelf: 'center', marginTop: pxToDp(40) }}>
                    <TouchableOpacity onPress={this.close} style={{ flexDirection: 'row' }}>
                        <View style={{ justifyContent: 'center' }}>
                            <Ionicons name="folder-outline" size={25} color="#000" />
                        </View>
                ...
                <View style={{ alignSelf: 'center', marginTop: 40 }}>
                    <TouchableOpacity
                        ...
                        <Text style={styles.textStyle}>地址管理</Text>
                    </TouchableOpacity>
                </View>
                <View style={{ alignSelf: 'center', marginTop: 40 }}>
                    <TouchableOpacity onPress={this.close} style={{ flexDirection: 'row' }}>
                        <View style={{ justifyContent: 'center' }}>
                            <Ionicons name="md-settings-outline" size={25} color="#000" />
                        </View>

                        <Text style={styles.textStyle}>基础设置</Text>
                    </TouchableOpacity>
                </View>
                <View style={{ alignSelf: 'center', marginTop: 40 }}>
                    <TouchableOpacity onPress={this.close} style={{ flexDirection: 'row' }}>
                        <View style={{ justifyContent: 'center' }}>
                            <Ionicons name="people-outline" size={25} color="#000" />
                        </View>

                        <Text style={styles.textStyle}>关于我们</Text>
                    </TouchableOpacity>
                </View>
            </View>
        );
        ...
        >
          <View style={{marginLeft:pxToDp(20)}}>
              ...
              <TouchableOpacity onPress={this.open}>
                ...
                <Ionicons name='menu' size={25} color="#468CD3" />
              </TouchableOpacity>
          ...
          <View style={styles.textview}>
            {/* 标题名 */}
            <Text style={{alignSelf:'center'}}>我的主页</Text>
          </View>
