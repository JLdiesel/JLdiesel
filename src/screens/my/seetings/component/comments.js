  ...
  <View>
      ...
      {this.props.comments.map((item,commentid)=>(
       ...
       <View style={{flexDirection:'row'}}>
                    ...
                    <View key={rpid}>
                     <View style={{flexDirection:'row',marginLeft:pxToDp(65)}}>
                    <Image source={{uri:item.rpimg}} style={{width:pxToDp(50),height:pxToDp(50),margin:pxToDp(15),borderRadius:pxToDp(40)}}/>
                    ...
                    <View style={{flexDirection:'row',position:'absolute',right:20,bottom:10,backgroundColor:'#ddd'}}>
                    <SvgUri svgXmlData={dianzan} width='20' height='20' style={{marginRight:20}}/>
                    <SvgUri svgXmlData={pinglun} width='20' height='20'/>
                    </View>
                     </View>
