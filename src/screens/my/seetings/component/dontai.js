...
class Index extends PureComponent {
  state = {
    dt: [{ name: 'wulawulaaaa', date: '2019-02-12' }, { name: 'wulawulaaaa', date: '2019-02-12' }, { name: 'wulawulaaaa', date: '2019-02-12' }, { name: 'wulawulaaaa', date: '2019-02-12' }
    ],
    list:[
      { title: '收藏' },
      { title: '举报' },
  ...
  render() {
      ...
      return (
        <ScrollView >
          ...
          <View style={{width:'95%',marginLeft:pxToDp(10),marginTop:pxToDp(20),marginBottom:pxToDp(20),backgroundColor:'#fff'}}>
      {this.props.dongtai.map((item,dtid)=>(  
        ...
        <View style={{flexDirection:'row',alignItems:'flex-end',marginBottom:pxToDp(10),marginLeft:pxToDp(10)}}>
      ...
      <View style={{elevation:1,borderWidth:0,backgroundColor:'#fcfcfc'}}>
          ...
          <View style={{flexDirection:'row',margin:pxToDp(10),}}>
            ...
            <View style={{width:'90%',marginBottom:pxToDp(30),alignSelf:'center'}}>
              ...
              <ScrollView style={{flex:1,height:pxToDp(150),marginTop:pxToDp(10)}} horizontal={true}>
                ...
                <TouchableOpacity onPress={()=>this.context.navigate('Indongtai')}>
