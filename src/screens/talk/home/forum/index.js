        ...
        imformation: [
            {
                ...
                answeravatar: "https://img0.baidu.com/it/u=3667585867,1791438963&fm=26&fmt=auto&gp=0.jpg",
                answername: "K宝爸吖",
                answertime: "7-20",
            ...
            },
            {
                ...
                title: "活动精选",
                comment: "文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介",
                comment: "哥，说实话，不像，就是头像和老薛差不多。",
                answeravatar: "https://img0.baidu.com/it/u=3667585867,1791438963&fm=26&fmt=auto&gp=0.jpg",
                answername: "K宝爸吖",
                answertime: "7-20",
            ...
            },
            {
                ...
                image: "https://img1.baidu.com/it/u=2409026093,3112973757&fm=26&fmt=auto&gp=0.jpg",
                title: "精选茶叶",
                comment: "文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介文章内容简介",
                comment: "哥，说实话，不像，就是头像和老薛差不多。",
                answeravatar: "https://img0.baidu.com/it/u=3667585867,1791438963&fm=26&fmt=auto&gp=0.jpg",
                answername: "K宝爸吖",
                answertime: "7-20",
                    ...
                    <View style={styles.container}>
                        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ height: pxToDp(0), bottom: pxToDp(20) }}>
                            <View style={{ top: pxToDp(30), marginLeft: pxToDp(10) }}>
                                <TouchableOpacity style={{ justifyContent: "center", alignItems: "center", width: pxToDp(200), height: pxToDp(90), borderRadius: pxToDp(10) }}>
                                    <ImageBackground source={require("../../../../res/play/1.jpg")} style={{ alignItems: "center", justifyContent: "center", width: "100%", height: "100%" }} imageStyle={{ borderRadius: pxToDp(10) }}>
                            ...
                            <View style={{ top: pxToDp(30), marginLeft: pxToDp(10) }}>
                                <TouchableOpacity style={{ justifyContent: "center", alignItems: "center", width: pxToDp(200), height: pxToDp(90), borderRadius: pxToDp(10) }}>
                                    <ImageBackground source={require("../../../../res/play/2.jpg")} style={{ alignItems: "center", justifyContent: "center", width: "100%", height: "100%" }} imageStyle={{ borderRadius: pxToDp(10) }}>
                                        <ImageBackground style={{ justifyContent: "center", alignItems: "center", backgroundColor: "black", width: "100%", height: "100%", borderRadius: pxToDp(10), opacity: 0.6 }}>
                            ...
                            <View style={{ top: pxToDp(30), marginLeft: pxToDp(10) }}>
                                <TouchableOpacity style={{ justifyContent: "center", alignItems: "center", width: pxToDp(200), height: pxToDp(90), borderRadius: pxToDp(10) }}>
                                    <ImageBackground source={require("../../../../res/play/3.jpg")} style={{ alignItems: "center", justifyContent: "center", width: "100%", height: "100%" }} imageStyle={{ borderRadius: pxToDp(10) }}>
                                        <ImageBackground style={{ justifyContent: "center", alignItems: "center", backgroundColor: "black", width: "100%", height: "100%", borderRadius: pxToDp(10), opacity: 0.6 }}>
                                            <Text style={{ color: "white", fontSize: pxToDp(20) }}>旅游路线</Text>
                                        </ImageBackground>
                                    </ImageBackground>
                                </TouchableOpacity>
                            </View>
                            <View style={{ top: pxToDp(30), marginLeft: pxToDp(10) }}>
                                <TouchableOpacity style={{ justifyContent: "center", alignItems: "center", width: pxToDp(200), height: pxToDp(90), borderRadius: pxToDp(10) }}>
                                    <ImageBackground source={require("../../../../res/play/4.jpg")} style={{ alignItems: "center", justifyContent: "center", width: "100%", height: "100%" }} imageStyle={{ borderRadius: pxToDp(10) }}>
                                        <ImageBackground style={{ justifyContent: "center", alignItems: "center", backgroundColor: "black", width: "100%", height: "100%", borderRadius: pxToDp(10), opacity: 0.6 }}>
                        ...
                        <View style={{ marginLeft: pxToDp(10), width: pxToDp(355), height: pxToDp(1), backgroundColor: 'black', opacity: 0.1 }} />
                    </View>
                    <View>
                        {imformation.map((item, index) => (
                            <View key={item.id} style={{ justifyContent: "center" }}>
                                ...
                                {/* 文章标签  开始 */}
                                <View style={{ flexDirection: "row", alignItems: "center", marginTop: pxToDp(5), marginLeft: pxToDp(40) }}>
                                    <TouchableOpacity style={{ marginLeft: pxToDp(15) }}>
                                ...
                                {/* 文章内容  开始 */}
                                <TouchableOpacity style={{ marginLeft: pxToDp(55), marginRight: pxToDp(15), marginTop: pxToDp(5) }}>
