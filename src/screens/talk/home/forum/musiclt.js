...
import { turquoise } from 'color-name'; import { FAB } from 'react-native-elements';
            ...
            {this.props.dongtai.map((item, dtid) => (
              ...
              <View key={dtid} style={{ elevation: 2, borderWidth: 0, marginBottom: pxToDp(20), backgroundColor: 'white', borderRadius: pxToDp(20) }}>
                ...
                <View style={{ flexDirection: 'row', margin: pxToDp(10), }}>
                  ...
                  <Image source={{ uri: item.dtimg }} style={{ width: pxToDp(60), height: pxToDp(60), borderRadius: pxToDp(40), marginLeft: pxToDp(20), marginTop: pxToDp(10) }} />
                  <TouchableOpacity onPress={() => this.context.navigate('Inluntan')}>
                    <View style={{ marginTop: pxToDp(10) }}>
                      <Text style={{ fontSize: pxToDp(25), fontWeight: 'bold', paddingLeft: pxToDp(20) }}>{item.name}</Text>
                      <Text style={{ fontSize: pxToDp(15), paddingLeft: pxToDp(20), marginTop: pxToDp(5) }}>{item.date}</Text>
