  ...
  renderHeader = (section) => {
    return (
      <View style={{ marginTop: pxToDp(10), alignItems: 'center' }}>
        <View style={{ flexDirection: 'row', width: pxToDp(330), justifyContent: 'space-between', alignItems: 'center' }}>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <Image style={{ height: pxToDp(60), width: pxToDp(60), borderRadius: pxToDp(30) }} source={section.path} />
            <View style={{ marginLeft: pxToDp(10) }}>
              <Text style={{ fontSize: pxToDp(17), fontWeight: 'bold', marginBottom: pxToDp(5) }}>{section.title}</Text>
              <Text style={{ fontSize: pxToDp(14) }}>{section.text}</Text>
            </View>
          </View>
          <Image style={{ width: pxToDp(20), height: pxToDp(20) }} source={require("../../../../res/箭头下.png")} />
        </View>
      </View>
    );
  };
    ...
    return (
      <View style={{ backgroundColor: '#ECF6FC', flex: 1 }}>
        ...
        <ScrollView style={{ marginRight: pxToDp(10), marginLeft: pxToDp(10) }}>
          <View>
            <Image source={require("../../../../res/genre/5.jpg")} style={{ width: "100%", height: pxToDp(210), borderRadius: pxToDp(10), marginTop: pxToDp(10) }} />
          </View>
          <Accordion
