                ...
                <View style={{ marginLeft: pxToDp(10), marginRight: pxToDp(10) }}>
                    ...
                    <ScrollView style={{ marginBottom: pxToDp(50) }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: pxToDp(10) }}>
                            <TouchableOpacity style={{ width: '48%', height: pxToDp(80), justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center' }}   onPress={() => this.context.navigate('Basic')}>
                            ...
                            <TouchableOpacity style={{ width: '48%', height: pxToDp(80), backgroundColor: 'rgba(255,255,255,0.5)', borderRadius: pxToDp(10), justifyContent: 'space-around', flexDirection: 'row', alignItems: 'center' }}   onPress={() => this.context.navigate('Master')}>
