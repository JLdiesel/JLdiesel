                    ...
                    <ScrollView style={{ marginBottom: pxToDp(50) }}>
                        ...
                        <View style={{ flex: 1 }}>
                            <Video
                                ...
                                shouldPlay={true}
                                isLooping={false}
                                style={{ width: pxToDp(355), height: pxToDp(200), margin: pxToDp(10) }}
                            />
                        </View>
                        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: pxToDp(10) }}>
                            <View style={{ width: '48%', height: pxToDp(80), justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center' }}>
                                <ImageBackground style={{ width: '98%', height: pxToDp(80), justifyContent: 'center', alignItems: 'flex-start' }} imageStyle={{ borderRadius: pxToDp(10) }} source={require('../../../res/31.jpg')}>
                                    <Text style={{ fontSize: pxToDp(18), fontWeight: 'bold', color: 'white', marginLeft: pxToDp(6) }}>传承计划</Text>
                                    <Text style={{ fontSize: pxToDp(14), color: 'white', marginLeft: pxToDp(6) }}>越剧基本功</Text>
                                </ImageBackground>
                            </View>
                            <View style={{ width: '48%', height: pxToDp(80), backgroundColor: 'rgba(255,255,255,0.5)', borderRadius: pxToDp(10), justifyContent: 'space-around', flexDirection: 'row', alignItems: 'center' }}>
                                <Image style={{ width: pxToDp(70), height: pxToDp(70), borderRadius: pxToDp(10) }} source={require('../../../res/genre/5.jpg')}></Image>
                                <View>
                                    <Text style={{ fontSize: pxToDp(18), fontWeight: 'bold', color: 'black' }}>名师推荐</Text>
                                    <Text style={{ fontSize: pxToDp(14), color: 'black' }}>越剧大师教学</Text>
                                </View>
                            </View>
                        </View>
                        {/*轮播图 */}
                        ...
                        <View style={{ height: pxToDp(220), flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                            <View style={{ width: '96%', height: '100%', }}>
                                <TouchableOpacity onPress={() => this.context.navigate()} >
                                    <ImageBackground style={{ width: '100%', height: pxToDp(220), }} imageStyle={{ borderRadius: pxToDp(10) }} source={{ uri: 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimg1.doubanio.com%2Fpview%2Fevent_poster%2Fraw%2Fpublic%2Ff3283bd44eec487.jpg&refer=http%3A%2F%2Fimg1.doubanio.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1631083362&t=f518e0105b6e4d70c8bd1515d98d8802' }}>
                                        <View style={{ justifyContent: 'center', alignItems: 'center', height: '76%' }}>
                                            <Image style={{ width: pxToDp(60), height: pxToDp(60) }}></Image>
                                        </View>
                        ...
                        {/*专栏 */}
                        <View style={{ margin: pxToDp(8), borderRadius: pxToDp(10), height: pxToDp(210), backgroundColor: 'rgba(255,255,255,0.5)' }}>
                            <ImageBackground style={{ width: '100%', height: pxToDp(140), }} imageStyle={{ borderTopLeftRadius: pxToDp(10), borderTopRightRadius: pxToDp(10) }} source={{ uri: 'https://tse2-mm.cn.bing.net/th/id/OIP-C.yUcdUl1MMg1qEIH3eSR2tQHaEo?w=258&h=180&c=7&o=5&dpr=1.75&pid=1.7' }}>
                                <View style={{ margin: pxToDp(10) }}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: pxToDp(8) }}>
                                        <TouchableOpacity onPress={() => this.context.navigate('MoreElegance')} style={{ alignItems: 'center', flexDirection: 'row' }}>
                                            <Text style={{ fontSize: pxToDp(18), fontWeight: 'bold' }}>梨树下</Text>
                                        </TouchableOpacity>
                                    </View>
                                    <Text style={{ fontSize: pxToDp(16) }}>前人风韵传后代</Text>
                                    <View horizontal={true} style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', marginTop: pxToDp(10) }}>
                                        <View style={{ width: '30%', height: pxToDp(140), borderRadius: pxToDp(10) }}>
                                            <ImageBackground style={{ width: '100%', height: pxToDp(100), flexDirection: 'row', alignItems: 'flex-end', }} imageStyle={{ borderRadius: pxToDp(10) }} source={{ uri: 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fn.sinaimg.cn%2Fsinakd2020723s%2F660%2Fw400h260%2F20200723%2F77aa-iwtqvyk3596226.jpg&refer=http%3A%2F%2Fn.sinaimg.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1631088242&t=8d11f82c9b8959e2ebe4a2f3d2da915c' }}>
                                            ...
                                            <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1 }}>
                                                <Text numberOfLines={1} style={{ fontSize: pxToDp(16) }}>越剧台步教学</Text>
                                            </View>
                                        </View>
                                        <View style={{ width: '30%', height: pxToDp(140), borderRadius: pxToDp(10) }}>
                                            <ImageBackground style={{ width: '100%', height: pxToDp(100), flexDirection: 'row', alignItems: 'flex-end', }} imageStyle={{ borderRadius: pxToDp(10) }} source={{ uri: 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimg.pconline.com.cn%2Fimages%2Fupload%2Fupc%2Ftx%2Fphotoblog%2F1805%2F12%2Fc4%2F86800294_1526116090750_mthumb.jpg&refer=http%3A%2F%2Fimg.pconline.com.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1631088747&t=39a0a671e23c977056b8eb6f6cccbef6' }}>
                                                <View style={{ margin: pxToDp(4), flexDirection: 'row', justifyContent: 'center' }}>
                                                    <Icon2 name="play-arrow" size={16} color={'white'} />
                                                    <Text style={{ color: 'white', marginLeft: pxToDp(4) }}>7589</Text>
                                                </View>
                                            ...
                                            <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1 }}>
                                                <Text numberOfLines={1} style={{ fontSize: pxToDp(16) }}>越剧水袖教学</Text>
                                            </View>
                                        </View>
                                        <View style={{ width: '30%', height: pxToDp(140), borderRadius: pxToDp(10) }}>
                                            <TouchableOpacity onPress={() => this.context.navigate('ListenList')}>
                                                <ImageBackground style={{ width: '100%', height: pxToDp(100), flexDirection: 'row', alignItems: 'flex-end', }} imageStyle={{ borderRadius: pxToDp(10) }} source={{ uri: 'https://img0.baidu.com/it/u=2176866696,2026454484&fm=26&fmt=auto&gp=0.jpg' }}>
                                                    <View style={{ margin: pxToDp(4), flexDirection: 'row', justifyContent: 'center' }}>
                                                        <Icon2 name="play-arrow" size={16} color={'white'} />
                                                        <Text style={{ color: 'white', marginLeft: pxToDp(4) }}>4289</Text>
                                                    </View>
                                                </ImageBackground>
                                            </TouchableOpacity>

                                            <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1 }}>
                                                <Text numberOfLines={1} style={{ fontSize: pxToDp(16) }}>越剧扇子的妙用</Text>
                                            </View>
                                        </View>
                                    </View>
                                </View>
                        ...
                        <View style={{ margin: pxToDp(8), borderRadius: pxToDp(20), height: pxToDp(110), }}>
                            <Carousel control style={{ height: pxToDp(110) }}>
                                ...
                                <View style={{ width: "100%", height: pxToDp(100), borderRadius: pxToDp(20), backgroundColor: 'rgba(255,255,255,0.5)', justifyContent: 'space-around', alignItems: 'center' }} >
                                    <View style={{ flexDirection: 'row', }}>
                                        <Image style={{ width: '38%', height: pxToDp(92), borderRadius: pxToDp(20) }} source={{uri:'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fupfile.cuepa.cn%2Fnewspics%2F2016%2F02%2Fs_184c49bcb3de665e32b015a291c0725d11750.jpg&refer=http%3A%2F%2Fupfile.cuepa.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1631089466&t=0622beb059cad15f78be53db35a89e9f'}}></Image>
                                        <View style={{ width: '58%', height: pxToDp(92), padding: pxToDp(8) }}>
