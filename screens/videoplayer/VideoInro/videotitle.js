    ...
    render() {
        ...
        return (
            <View style={{ marginVertical: 2, padding: 10, }}>
                        <View>
                            <Text style={{ fontSize: pxToDp(18), fontWeight: 'bold' }}>{this.props.title}</Text>
                            <Text style={{ fontSize: pxToDp(14), color: 'gray' }}>{this.props.play}播放&emsp;{this.props.like}喜欢</Text>
                        </View>
