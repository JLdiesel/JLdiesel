...
<<<<<<< HEAD
  state = {
    ...
    video: {
      id: 1,
      videouri:
        '"https://vd3.bdstatic.com/mda-jmr9nwe0scccdqs8/sc/mda-jmr9nwe0scccdqs8.mp4?playlist=%5B%22hd%22%2C%22sc%22%5D&v_from_s=hkapp-haokan-suzhou&auth_key=1626854002-0-0-c5ad25f8f12dd38fec769c93fc6d4a61&bcevod_channel=searchbox_feed&pd=1&pt=3&abtest=",',
      ...
      plvideo: [
        {
          ...
          date: '2021-8-6',
          comdz: '101',
          usercom: '山东话版的林妹妹。有几分林黛玉倒把垂杨柳的风味了1',
          userscom: '海十七侠：河南话的李师师，陕西话的貂蝉，山西话的杨玉环1'
        },
        {
          id: 2,
          userimg: '',
          ...
          date: '2021-8-6',
          comdz: '112',
          usercom: '山东话版的林妹妹。有几分林黛玉倒把垂杨柳的风味了2',
          userscom: '海十七侠：河南话的李师师，陕西话的貂蝉，山西话的杨玉环2'
        },
        {
          id: 3,
          userimg: '',
          ...
          date: '2021-8-6',
          comdz: '123',
          usercom: '山东话版的林妹妹。有几分林黛玉倒把垂杨柳的风味了3',
          userscom: '海十七侠：河南话的李师师，陕西话的貂蝉，山西话的杨玉环3'
        }
      ]
    }
  };
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        >
          <VideoPlayScreen
            onIt={this.onIt}
            videouri={this.state.video.videouri}
          />
        ...
        >
          <VideoInro tabLabel="简介" all={{ ...this.state.video }}></VideoInro>
          <VideoCom
            tabLabel="评论"
